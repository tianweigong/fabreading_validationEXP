...
a=dt%>%summarySE(measurevar = "dat_Accuracy",groupvars = c("dat_Subject","con"))
...
dt.pair$causal=as.numeric(as.logical(dt.pair$causal))
dt.pair$non_causal=as.numeric(as.logical(dt.pair$non_causal))
...
skewness(log(dt.pair$causal+10000))
skewness(log(dt.pair$non_causal+10000))
